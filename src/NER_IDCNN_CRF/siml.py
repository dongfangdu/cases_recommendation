...
import numpy
import Levenshtein
from calculate_i_s_d_wer import get_step_list,edit_distance
from Calculate_WER2_3 import editDistance
...
if __name__ == "__main__":
    ...
    c = "abc"
    d = "abc"
    print(Levenshtein.editops(a,b))
    # print(Levenshtein.distance(d,c))
    # print(Levenshtein.jaro(c,d))
    # calllevenshtein1(a, b, n)
    print(levenshtein2(a, b))
